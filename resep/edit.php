    ...
    <div class="form-container">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <label for="gambar" style="margin-top: 1.5rem;">URL/Link Gambar Masakan</label>
                <input type="url" id="gambar" name="gambar" class="form-control" value="<?= htmlspecialchars($row['gambar']) ?>" placeholder="Tempel URL gambar internet (misal: dari TheMealDB)...">
            </div>
            ...
            <button type="submit" class="btn btn-primary btn-large" style="width: 100%; border: none;"><i class="fa-solid fa-floppy-disk"></i> Simpan Perubahan</button>
        </form>
    </div>
</div>
